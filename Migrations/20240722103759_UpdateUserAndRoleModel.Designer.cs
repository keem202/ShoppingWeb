...
namespace OnlineShoppingAPI.Migrations
{
    ...
    [Migration("20240722103759_UpdateUserAndRoleModel")]
    partial class UpdateUserAndRoleModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineShoppingAPI.Models.OrderDetail", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineShoppingAPI.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineShoppingAPI.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("OnlineShoppingAPI.Models.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("OnlineShoppingAPI.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineShoppingAPI.Models.Cart", b =>
                {
                    b.HasOne("OnlineShoppingAPI.Models.Product", "Product")
                        .WithMany("Carts")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnlineShoppingAPI.Models.User", "User")
                        .WithMany("Carts")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OnlineShoppingAPI.Models.OrderDetail", b =>
                {
                    b.HasOne("OnlineShoppingAPI.Models.Order", "Order")
